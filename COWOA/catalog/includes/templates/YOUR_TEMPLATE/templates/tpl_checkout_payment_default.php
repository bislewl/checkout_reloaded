...
?>
    ...
    <div class="buttonRow forward"><?php echo zen_image_submit(BUTTON_IMAGE_SEND_ORDER, BUTTON_SEND_ORDER_ALT, 'onclick="submitFunction(' . zen_user_has_gv_account($_SESSION['customer_id']) . ',' . $order->info['total'] . ')"'); ?></div>
